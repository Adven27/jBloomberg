...
final class SubscriptionManager {
    ...
    public Map<String, CorrelationID> tickerSubscriptions() {
        return subscriptionsById.entrySet().stream()
            .collect(toMap(e -> e.getValue().ticker, Map.Entry::getKey));
    }
    ...
    private Subscription getSubscription(String ticker, SubscriptionBuilder builder) {
        ...
        SubscriptionHolder sh = new SubscriptionHolder(id, ticker);
    ...
    private static class SubscriptionHolder {
        ...
        public SubscriptionHolder(CorrelationID id, String ticker) {
            this.id = id;
            this.ticker = ticker;
        }
