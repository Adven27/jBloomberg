...
import static com.assylias.jbloomberg.SessionState.*;
...
public class DefaultBloombergSession implements BloombergSession {
     ...
     */
    protected final BloombergEventHandler eventHandler;
    /**
    ...
    protected Map<String, CorrelationID> getTickerSubscriptions(){
        return subscriptionManager.tickerSubscriptions();
    }
